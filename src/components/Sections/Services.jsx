          ...
          <ServiceBoxRow className="flex ">
            ...
            <ServiceBoxWrapper>
              <ServiceBox
                ...
                subtitle="Kompaniyamiz tomonidan haridorlarga qulaylik yaratish maqsaida yetkazib berish xizmati tashkil etilgan."
              />
            </ServiceBoxWrapper>
            <ServiceBoxWrapper>
              <ServiceBox
            ...
            <ServiceBoxWrapper>
              <ServiceBox
                ...
                subtitle="Asosiy yutuqlarimizdan yana biri kompaniyamizning mahsulotlar assortementi ko'pligida bo'lib siz bu yerda 2500 turdan ortiq mahsulotlarni ulgirji va chakana xarid qilishingiz mumkin ."
              />
            </ServiceBoxWrapper>
          </ServiceBoxRow>
        </div>
